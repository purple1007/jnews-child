...
Class SinglePost {
  ...
  // 上下篇文章
		add_action( 'jnews_single_post_after_content', array( $this, 'next_prev_content_hook' ), 30 );
  // 作者介紹
		add_action( 'jnews_single_post_after_content', array( $this, 'author_box_hook' ), 20 );
  // 相關文章
  ...
  // 回到上一頁
    add_action( 'jnews_single_post_after_content', array( $this, 'render_back_button' ), 70 );
	}
  ...
  public function render_back_button() {
    ...
    echo "<div class=\"align-center\"><a {$url} class=\"btn btn-primary\">" . jnews_return_translation( 'Back to List', 'jnews', 'back to list' ) . "</a></div>";
  }
}
